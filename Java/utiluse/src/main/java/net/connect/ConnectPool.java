...
public class ConnectPool<M> implements Sender<ConnectPool, M> {
	...
	public void initPool() {
		...
		this.pool = new FixedChannelPool(bootstrap, new ConnectPool.InnerChannelPoolHandler(), ChannelHealthChecker.ACTIVE, AcquireTimeoutAction.NEW, 0L, this.maxSize, 2147483647);
	}
