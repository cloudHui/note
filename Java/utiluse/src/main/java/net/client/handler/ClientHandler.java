...
public class ClientHandler<T extends ClientHandler, M> extends ChannelInboundHandlerAdapter implements Sender<T, M> {
	...
	private static final ClientHandler.ClientManager clientManager;
	...
	static {
		clientManager = ClientHandler.ClientManager.INSTANCE;
		DEFAULT_DATA = "".getBytes();
	}

	private static class ClientManager {
		private static final ClientHandler.ClientManager INSTANCE = new ClientHandler.ClientManager();
