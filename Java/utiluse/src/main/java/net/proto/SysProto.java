...
public final class SysProto {
	...
	public static final class SysMessage extends GeneratedMessage implements SysProto.SysMessageOrBuilder {
		private static final SysProto.SysMessage defaultInstance = new SysProto.SysMessage(true);
		private final UnknownFieldSet unknownFields;
		public static Parser<SysProto.SysMessage> PARSER = new AbstractParser<SysProto.SysMessage>() {
			public SysProto.SysMessage parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
				return new SysProto.SysMessage(input, extensionRegistry);
			}
		};
		...
		public static SysProto.SysMessage getDefaultInstance() {
			return defaultInstance;
		}

		public SysProto.SysMessage getDefaultInstanceForType() {
			return defaultInstance;
		}
		...
		protected FieldAccessorTable internalGetFieldAccessorTable() {
			return SysProto.internal_static_proto_SysMessage_fieldAccessorTable.ensureFieldAccessorsInitialized(SysProto.SysMessage.class, SysProto.SysMessage.Builder.class);
		}

		public Parser<SysProto.SysMessage> getParserForType() {
			return PARSER;
		}
		...
		public static SysProto.SysMessage parseFrom(ByteString data) throws InvalidProtocolBufferException {
			return (SysProto.SysMessage) PARSER.parseFrom(data);
		}

		public static SysProto.SysMessage parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
			return (SysProto.SysMessage) PARSER.parseFrom(data, extensionRegistry);
		}

		public static SysProto.SysMessage parseFrom(byte[] data) throws InvalidProtocolBufferException {
			return (SysProto.SysMessage) PARSER.parseFrom(data);
		}

		public static SysProto.SysMessage parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
			return (SysProto.SysMessage) PARSER.parseFrom(data, extensionRegistry);
		}

		public static SysProto.SysMessage parseFrom(InputStream input) throws IOException {
			return (SysProto.SysMessage) PARSER.parseFrom(input);
		}

		public static SysProto.SysMessage parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
			return (SysProto.SysMessage) PARSER.parseFrom(input, extensionRegistry);
		}

		public static SysProto.SysMessage parseDelimitedFrom(InputStream input) throws IOException {
			return (SysProto.SysMessage) PARSER.parseDelimitedFrom(input);
		}

		public static SysProto.SysMessage parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
			return (SysProto.SysMessage) PARSER.parseDelimitedFrom(input, extensionRegistry);
		}

		public static SysProto.SysMessage parseFrom(CodedInputStream input) throws IOException {
			return (SysProto.SysMessage) PARSER.parseFrom(input);
		}

		public static SysProto.SysMessage parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
			return (SysProto.SysMessage) PARSER.parseFrom(input, extensionRegistry);
		}

		public static SysProto.SysMessage.Builder newBuilder() {
			return SysProto.SysMessage.Builder.create();
		}

		public SysProto.SysMessage.Builder newBuilderForType() {
			return newBuilder();
		}

		public static SysProto.SysMessage.Builder newBuilder(SysProto.SysMessage prototype) {
			return newBuilder().mergeFrom(prototype);
		}

		public SysProto.SysMessage.Builder toBuilder() {
			return newBuilder(this);
		}

		protected SysProto.SysMessage.Builder newBuilderForType(BuilderParent parent) {
			SysProto.SysMessage.Builder builder = new SysProto.SysMessage.Builder(parent);
			return builder;
		}
		...
		public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<SysProto.SysMessage.Builder> implements SysProto.SysMessageOrBuilder {
			private int bitField0_;
			private ByteString version_;
			private long sequence_;
			private int msgId_;
			...
			private void maybeForceBuilderInitialization() {
				if (SysProto.SysMessage.alwaysUseFieldBuilders) {
					this.getExtendsFieldBuilder();
				}

			}

			private static SysProto.SysMessage.Builder create() {
				return new SysProto.SysMessage.Builder();
			}

			public SysProto.SysMessage.Builder clear() {
				super.clear();
				this.version_ = ByteString.EMPTY;
				this.bitField0_ &= -2;
				this.sequence_ = 0L;
			...
			public SysProto.SysMessage.Builder clone() {
			...
			public SysProto.SysMessage getDefaultInstanceForType() {
				return SysProto.SysMessage.getDefaultInstance();
			}

			public SysProto.SysMessage build() {
				SysProto.SysMessage result = this.buildPartial();
			...
			public SysProto.SysMessage buildPartial() {
				SysProto.SysMessage result = new SysProto.SysMessage(this);
			...
			public SysProto.SysMessage.Builder mergeFrom(Message other) {
				if (other instanceof SysProto.SysMessage) {
					return this.mergeFrom((SysProto.SysMessage) other);
				} else {
			...
			public SysProto.SysMessage.Builder mergeFrom(SysProto.SysMessage other) {
				if (other == SysProto.SysMessage.getDefaultInstance()) {
					return this;
				} else {
					if (other.hasVersion()) {
					...
					if (this.extendsBuilder_ == null) {
						...
						if (this.extendsBuilder_.isEmpty()) {
							...
							this.extends_ = other.extends_;
							this.bitField0_ &= -17;
							this.extendsBuilder_ = SysProto.SysMessage.alwaysUseFieldBuilders ? this.getExtendsFieldBuilder() : null;
						} else {
			...
			public SysProto.SysMessage.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
				SysProto.SysMessage parsedMessage = null;

				try {
					parsedMessage = (SysProto.SysMessage) SysProto.SysMessage.PARSER.parsePartialFrom(input, extensionRegistry);
				} catch (InvalidProtocolBufferException var8) {
					parsedMessage = (SysProto.SysMessage) var8.getUnfinishedMessage();
					throw var8;
				} finally {
			...
			public SysProto.SysMessage.Builder setVersion(ByteString value) {
				if (value == null) {
			...
			public SysProto.SysMessage.Builder clearVersion() {
				this.bitField0_ &= -2;
				this.version_ = SysProto.SysMessage.getDefaultInstance().getVersion();
				this.onChanged();
				return this;
			}
			...
			public SysProto.SysMessage.Builder setSequence(long value) {
				this.bitField0_ |= 2;
			...
			public SysProto.SysMessage.Builder clearSequence() {
				this.bitField0_ &= -3;
				this.sequence_ = 0L;
				this.onChanged();
				return this;
			...
			public SysProto.SysMessage.Builder setMsgId(int value) {
				this.bitField0_ |= 4;
				this.msgId_ = value;
				this.onChanged();
				return this;
			...
			public SysProto.SysMessage.Builder clearMsgId() {
				this.bitField0_ &= -5;
				this.msgId_ = 0;
				this.onChanged();
				return this;
			...
			public SysProto.SysMessage.Builder setInnerMsg(ByteString value) {
				if (value == null) {
					throw new NullPointerException();
				} else {
					this.bitField0_ |= 8;
			...
			public SysProto.SysMessage.Builder clearInnerMsg() {
				this.bitField0_ &= -9;
				this.innerMsg_ = SysProto.SysMessage.getDefaultInstance().getInnerMsg();
				this.onChanged();
				return this;
			}
			...
			public SysProto.SysMessage.Builder setExtends(int index, KStrVPair value) {
				if (this.extendsBuilder_ == null) {
					if (value == null) {
						throw new NullPointerException();
					}
			...
			public SysProto.SysMessage.Builder setExtends(int index, net.proto.CommonProto.KStrVPair.Builder builderForValue) {
				if (this.extendsBuilder_ == null) {
					this.ensureExtendsIsMutable();
			...
			public SysProto.SysMessage.Builder addExtends(KStrVPair value) {
				if (this.extendsBuilder_ == null) {
					if (value == null) {
						throw new NullPointerException();
					}
			...
			public SysProto.SysMessage.Builder addExtends(int index, KStrVPair value) {
				if (this.extendsBuilder_ == null) {
					if (value == null) {
						throw new NullPointerException();
					}
			...
			public SysProto.SysMessage.Builder addExtends(net.proto.CommonProto.KStrVPair.Builder builderForValue) {
				if (this.extendsBuilder_ == null) {
					this.ensureExtendsIsMutable();
			...
			public SysProto.SysMessage.Builder addExtends(int index, net.proto.CommonProto.KStrVPair.Builder builderForValue) {
				if (this.extendsBuilder_ == null) {
					this.ensureExtendsIsMutable();
			...
			public SysProto.SysMessage.Builder addAllExtends(Iterable<? extends KStrVPair> values) {
				if (this.extendsBuilder_ == null) {
					this.ensureExtendsIsMutable();
			...
			public SysProto.SysMessage.Builder clearExtends() {
				if (this.extendsBuilder_ == null) {
					this.extends_ = Collections.emptyList();
					this.bitField0_ &= -17;
					this.onChanged();
			...
			public SysProto.SysMessage.Builder removeExtends(int index) {
				if (this.extendsBuilder_ == null) {
					this.ensureExtendsIsMutable();
