...
public class KugouMusicSource implements MusicSource {
	...
	public MusicInfo get(String keyword) throws Exception {
		...
		JsonObject je = JsonParser
				.parseString(new String(Utils.readAll(huc.getInputStream()), StandardCharsets.UTF_8).replaceAll("<!--[_A-Z]+-->", ""))
				.getAsJsonObject();
		...
		ihuc.connect();
		JsonObject info = JsonParser.parseString(new String(Utils.readAll(ihuc.getInputStream()), StandardCharsets.UTF_8))
