...
public class XimalayaSource implements MusicSource {
	...
	public MusicInfo get(String keyword) throws Exception {
		...
		JsonArray ja = JsonParser
				.parseString(new String(Utils.readAll(huc.getInputStream()), StandardCharsets.UTF_8))
		...
		huc2.connect();
		String out = new String(Utils.readAll(huc2.getInputStream()), StandardCharsets.UTF_8);
