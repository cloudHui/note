 ...
 * MCP 错误对象。
 *
 * <p>code 为机器可读的错误码，message 为人类可读的简要描述。</p>
 * <p>当前错误码由入口统一生成，例如：PARSE_ERROR、INVALID_REQUEST、METHOD_NOT_FOUND、
 * INVALID_PARAMS、INTERNAL_ERROR。</p>
 */
...
public class McpError extends McpResponse {
    ...
    public String toString() {
        return "McpError{id=" + id + ", error=" + error + "}";
    }
}
